...
public interface GUIManager {
    ...
    default void open(@NotNull DCPlayer player, @NotNull CaseDefinition caseDefinition, @NotNull CaseLocation location) {
        open(player, caseDefinition, caseDefinition.defaultMenu(), location);
    }
     ...
     * @since 2.1.0.5
     */
    void open(@NotNull DCPlayer player, @NotNull CaseDefinition caseDefinition, @NotNull CaseMenu menu, @NotNull CaseLocation location);
