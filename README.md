...
[![DonateCaseAPI](https://repo.jodexindustries.xyz/api/badge/latest/releases/com/jodexindustries/donatecase/spigot
?color=40c14a&name=DonateCaseAPI&prefix=v)](https://wiki.jodexindustries.xyz/docs/DonateCase/API/install)
