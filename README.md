...
[![DonateCaseAPI](https://repo.jodexindustries.xyz/api/badge/latest/releases/com/jodexindustries/donatecase/DonateCaseAPI?color=40c14a&name=DonateCaseAPI&prefix=v)](https://wiki.jodexindustries.xyz/docs/DonateCase/API/install)
...
```
```groovy
compileOnly("com.jodexindustries.donatecase:DonateCaseAPI:2.2.6.1")
```
