package com.jodexindustries.donatecase.common.entity.meta.armorstand;

import com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes;
import com.github.retrooper.packetevents.util.Vector3f;
import com.jodexindustries.donatecase.common.entity.meta.EntityMeta;
import com.jodexindustries.donatecase.common.entity.meta.LivingEntityMeta;
...
public class ArmorStandMeta extends LivingEntityMeta {
    ...
    public ArmorStandMeta(int entityId) {
        super(entityId);
    }

    public ArmorStandMeta(EntityMeta metadata) {
        super(metadata);
    }
