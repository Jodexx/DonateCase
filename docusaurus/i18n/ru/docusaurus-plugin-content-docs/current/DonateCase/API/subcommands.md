...
## ~~Старый метод~~
Чтобы создать класс подкоманды, мы будем использовать [SubCommand](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/DonateCaseAPI/2.2.6.2/raw/com/jodexindustries/donatecase/api/data/SubCommand.html) интерфейс
